...
class RedisUtil(object):
    def __init__(self):
        ...
        self.cookie_nick = 'cookie-{}'  # 方便后面 format
    ...
    def get_token(self, nick):
        ...
        return None if not token else token.decode()  # bytes 需解码为 string
    ...
    def get_chat_list(self):
        ...
        chat_info_list = []
        key = self.chat_list
        messages = self.client.lrange(key, -20, -1)
        for message in messages:
            chat_info = json.loads(message.decode())
