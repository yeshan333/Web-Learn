...
app.config.update(
    ...
    MAIL_DEFAULT_SENDER=('yeshan', os.getenv('MAIL_USERNAME'))
)
...
app.config.update(
    ...
    MAIL_PORT = 587,
    MAIL_USE_TSL=True,
    MAIL_USERNAME='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',
    MAIL_PASSWORD=os.getenv('MAIL_PASSWORD'),
    MAIL_DEFAULT_SENDER=('yeshan', os.getenv('MAIL_USERNAME'))
) """
...
def send_api_mail(subject, to, body):
    ...
    from_email = SGEmail('1329441308@qq.com')
    to_email = SGEmail(to)
